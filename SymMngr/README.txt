A wrapper library over DBGHELP.DLL for symbol handling in managed programs.

References
==========

[1] Using SymSrv
https://msdn.microsoft.com/en-us/library/windows/desktop/ms681416(v=vs.85).aspx
[2] Using SymStore
https://msdn.microsoft.com/en-us/library/windows/desktop/ms681417(v=vs.85).aspx
[3] Explicit Symbol Loading with dbghelp
